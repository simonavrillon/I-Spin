classdef Quattrodlg < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function OKButtonPushed(app, event)
            ...
            app.file.signal.ports = ports;
            app.file.signal.adapter = grid;
